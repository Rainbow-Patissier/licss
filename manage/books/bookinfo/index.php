...
<section id="main_content"><?php
	...
	<div>
		...
		<div>
			<a href="#manage_books_bookinfo_import_table">登録成功</a>
			<a href="#manage_books_bookinfo_import_failed_table">登録失敗</a>
		</div>
		<div class="scroll">
			<table style="font-size: 9pt;" id="manage_books_bookinfo_import_table">
				<caption>
					登録成功リスト
				</caption>
				<thead>
		...
		<div class="scroll">
			<table style="font-size: 9pt;" id="manage_books_bookinfo_import_failed_table">
				<caption>
					登録不可リスト
				</caption>
				<thead>
